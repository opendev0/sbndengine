...
int main(int argc, char **argv)
{
	...
	{
		iApplication *cA = (argc > 1 && std::string(argv[1]) == "startgame") ? static_cast<iApplication *>(new GameApplication) : static_cast<iApplication *>(new cApplicationImplementation);
