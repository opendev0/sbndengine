...
#ifndef __I_PHYSICS_SOFT_CONSTRAINT_SPRING_HPP__
#define __I_PHYSICS_SOFT_CONSTRAINT_SPRING_HPP__
...
/**
 * physics spring implemented by a soft constraint.
 *
 * the force is added to the force accumulator of both objects
 */
class cPhysicsSoftConstraintSpring	: public iPhysicsSoftConstraint
{
