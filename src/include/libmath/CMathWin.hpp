...
#ifndef sqrtl
#define	m_sqrtl(x)	((unsigned long)(float)::sqrt((double)x))
#else
...
/** return PI */
template <>	inline float	CMath<float>::PI()				{	return (float)M_PI;	}
...
/** return square root of a */
template <>	inline int		CMath<int>::sqrt(int a)			{	return static_cast<int>(m_sqrtl(static_cast<unsigned long>(a)));	}
...
template <>	inline float	CMath<float>::aton(const char *s)	{	return (float)::atof(s);	}
/** convert string to type double */
template <>	inline double	CMath<double>::aton(const char *s)	{	return (double)::atof(s);	}
/** convert string to type int */
template <>	inline int		CMath<int>::aton(const char *s)		{	return (int)::atoi(s);	}
...
/** inverse sinus of s */
template <>	inline float	CMath<float>::asin(float s)	{	return asinf(s);	}
/** inverse cosinus of s */
template <>	inline float	CMath<float>::acos(float s)	{	return acosf(s);	}
/** inverse tangens of s */
template <>	inline float	CMath<float>::atan(float s)	{	return atanf(s);	}
